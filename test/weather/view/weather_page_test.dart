...
class MockWeatherRepository extends Mock implements repo.WeatherRepository {}
...
void main() {
  ...
  group('WeatherPage', () {
    late repo.WeatherRepository weatherRepository;
...
/*
  group('WeatherView', () {
    ...
    testWidgets('calls updateTheme when whether changes', (tester) async {
      ...
      //verify(() => themeCubit.updateTheme(weather as Weather?)).called(1);
    });
